...
# Check Python
echo -e "${WHITE}[1/4]${NC} Vérification de Python..."
...
# Create venv
echo -e "${WHITE}[2/4]${NC} Création de l'environnement virtuel..."
if [ ! -d "$VENV_DIR" ]; then
...
# Install deps
echo -e "${WHITE}[3/4]${NC} Installation des dépendances..."
...
# Create directories
echo -e "${WHITE}[4/4]${NC} Préparation du stockage..."
